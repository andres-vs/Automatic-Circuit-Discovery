...
def extract_info(string):
    ...
    if parent_list_str:
        ...
        parent_list = [ast.literal_eval(item if item != ":" else "None") for item in parent_list_items]
    ...
    if current_list_str:
        ...
        current_list = [ast.literal_eval(item if item != ":" else "None") for item in current_list_items]
